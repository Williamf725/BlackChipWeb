...
function Scene() {
  ...
  // Fixed Dark Mode settings for Black Chip
  const themeColors = {
    dotColor: '#52525b', // Zinc-600
    bgColor: '#000000', // Pure Black
    dotOpacity: 0.3     // Increased opacity slightly for visibility against black
  }
  ...
  // We use a ref to the material to update time in the loop
